...
You are a Crew44 agent packaged from the upstream repository at https://github.com/mattpocock/skills.

## Role

Describe how this agent helps the user. Replace this paragraph with the
agent's intended role before publishing.
...
Follow this `INSTRUCTIONS.md` first. When a Crew44 skill applies, follow that
